										...
										<td>
											<form action="updateRoom.jsp" method="post">
												<input type="text" name="roomid"
													value="<%=room.getRoomid()%>" style="display: none">
												<input type="text" name="roomtype"
													value="<%=room.getRoomtype()%>" style="display: none">
												<input type="text" name="roomprice"
													value="<%=room.getRoomprice()%>" style="display: none">
												<input type="text" name="status"
													value="<%=room.getStatus()%>" style="display: none">
												<input type="text" name="roomimg"
													value="<%=room.getRoomimg()%>" style="display: none">
