                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                value="<%=new String(request.getParameter("staffid").getBytes("ISO8859_1"),"utf-8")%>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input name="staffname" id="staffname" type="text" class="form-control"
                                value="<%=new String(request.getParameter("staffname").getBytes("ISO8859_1"),"utf-8")%>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input name="duty" id="duty" type="text" class="form-control"
                                value="<%=new String(request.getParameter("duty").getBytes("ISO8859_1"),"utf-8")%>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <select name="status" id="status" class="form-control">
                                    <option value="忙" id="忙" name="忙">忙</option>
                                    <option value="空闲" id="空闲" name="空闲">空闲</option>
                                    <option value="休假" id="休假" name="休假">休假</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                value="<%=new String(request.getParameter("phone").getBytes("ISO8859_1"),"utf-8")%>">
                            </div>
                        </div>
