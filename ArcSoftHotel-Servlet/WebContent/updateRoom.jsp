                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input name="roomtype" id="roomtype" type="text" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input name="roomimg" id="roomimg" type="text" class="form-control"
                                value="<%=new String(request.getParameter("roomimg").getBytes("ISO8859_1"),"utf-8")%>">
                            </div>
                        </div>
