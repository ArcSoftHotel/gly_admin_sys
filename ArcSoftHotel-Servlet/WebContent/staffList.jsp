									...
									<td>
										<form action="updateStaff.jsp" method="post">
											<input type="text" name="staffid"
												value="<%=staff.getStaffid()%>" style="display: none">
											<input type="text" name="staffname"
												value="<%=staff.getStaffname()%>" style="display: none">
											<input type="text" name="duty" value="<%=staff.getDuty()%>"
												style="display: none"> <input type="text"
												name="status" value="<%=staff.getStatus()%>"
												style="display: none"> <input type="text"
												name="phone" value="<%=staff.getPhone()%>"
												style="display: none">
